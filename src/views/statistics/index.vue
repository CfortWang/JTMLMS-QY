          ...
          <dv-border-box-1 style="width: 100%; height: 89%;box-sizing: border-box; overflow: hidden">
            ...
            <div class="congxiebox7" style="display:inline-block;width:98%;margin-right:1%;margin-left:1%;height:43%;" v-if="pageOT==1">
              ...
              <div class="componentsData" style="height:87%" v-if="relOf">
                <!-- <buhegeyangpinPie style="height:100%"  :width="displayType=='row' ? '25%': '100%'" :colorw = "colorw"
                  v-if="zaigangrenyuan.length>0&&(showAll || showComponents[24])" :data = "getbuhegeyangpin()"/> -->
                <buhegeyangpinPie style="height:100%"  :width="displayType=='row' ? '25%': '100%'" :colorw = "colorw" :id="'bhgyp'" :wancheng="'合格率'" :weiwancheng="'不合格率'"
                  v-if="showAll ||showComponents[24]" :data = "getbuhegeyangpin()"/>
                <buhegeyangpinBar style="height:100%"  :width="displayType=='row' ? '75%': '100%'" :colorw = "colorw" :id="'bhgypb'"
            ...
            <div class="congxiebox7" style="display:inline-block;width:98%;margin-right:1%;margin-left:1%;height:43%;" v-if="pageOT==1">
              ...
              <div class="componentsData" style="height:87%" v-if="relOf">
                <baogaobuzhengquePie style="height:100%"  :width="displayType=='row' ? '25%': '100%'" :colorw = "colorw" :id="'bgbhg'" :wancheng="'正确率'" :weiwancheng="'不正确率'"
                  v-if="showAll ||showComponents[26]" :data = "getbaogaobuzhengque()"/>
                <baogaobuzhengqueBar style="height:100%"  :width="displayType=='row' ? '75%': '100%'" :colorw = "colorw" :id="'bhgypb'"
            ...
            <div class="congxiebox7" style="display:inline-block;width:98%;;margin-right:1%;margin-left:1%;height:90%;" v-if="pageOT==2">
              ...
              <div class="componentsData" style="height:87%" v-if="relOf">
                <weijizhibaogaoPie style="height:50%"  :width="displayType=='row' ? '25%': '100%'" :colorw = "colorw" :id="'wjzbg'" :wancheng="'报告率'" :weiwancheng="'未报告率'"
                  v-if="showAll ||showComponents[28]" :data = "getweijizhibaogao()"/>
                <weijizhibaogaoBar style="height:50%"  :width="displayType=='row' ? '75%': '100%'" :colorw = "colorw" :id="'wjzbgb'"
                  v-if="showAll || showComponents[29]" :data = "getweijizhibaogaoB()"/>
                <!-- <div class="nullDate1" style="height:50%;width:75%;" v-if="zaigangrenyuanfb.length<=0&&(showAll || showComponents[2])">暂无数据</div> -->
                <weijizhijishiPie style="height:50%"  :width="displayType=='row' ? '25%': '100%'" :colorw = "colorw" :id="'wjzbgjs'" :wancheng="'及时率'" :weiwancheng="'不及时率'"
                  v-if="showAll ||showComponents[30]" :data = "getweijizhijishi()"/>
                <weijizhijishiBar style="height:50%"  :width="displayType=='row' ? '75%': '100%'" :colorw = "colorw" :id="'wjzbgjsb'"
            ...
            <div class="congxiebox7" style="display:inline-block;width:98%;;margin-right:1%;margin-left:1%;height:90%;" v-if="pageOT==3">
              ...
              <div class="componentsData" style="height:87%" v-if="relOf">
                <sysnzzsjfhPie style="height:50%"  :width="displayType=='row' ? '25%': '100%'" :colorw = "colorw" :id="'sysnzzsjfh'" :wancheng="'符合率'" :weiwancheng="'不符合率'"
                  v-if="showAll ||showComponents[32]" :data = "getsysnzzsjfh()"/>
                <sysnzzsjfhBar style="height:50%"  :width="displayType=='row' ? '75%': '100%'" :colorw = "colorw" :id="'sysnzzsjfhb'"
                  v-if="showAll || showComponents[33]" :data = "getsysnzzsjfhB()"/>
                <!-- <div class="nullDate1" style="height:50%;width:75%;" v-if="zaigangrenyuanfb.length<=0&&(showAll || showComponents[2])">暂无数据</div> -->
                <jyqzzzwsPie style="height:50%"  :width="displayType=='row' ? '25%': '100%'" :colorw = "colorw" :id="'jyqzzzws'" :wancheng="'中位数达标率'" :weiwancheng="'中位数不达标率'"
                  v-if="showAll ||showComponents[34]" :data = "getjyqzzzws()"/>
                <jyqzzzwsBar style="height:50%"  :width="displayType=='row' ? '75%': '100%'" :colorw = "colorw" :id="'jyqzzzwsb'"
            ...
            <div class="congxiebox7" style="display:inline-block;width:98%;margin-right:1%;margin-left:1%;height:43%;" v-if="pageOT==4">
              ...
              <div class="componentsData" style="height:87%" v-if="relOf">
                <!-- <buhegeyangpinPie style="height:100%"  :width="displayType=='row' ? '25%': '100%'" :colorw = "colorw"
                  v-if="zaigangrenyuan.length>0&&(showAll || showComponents[24])" :data = "getbuhegeyangpin()"/> -->
                <bshineizhikongPie style="height:100%"  :width="displayType=='row' ? '25%': '100%'" :colorw = "colorw" :id="'snzk'" :wancheng="'达标率'" :weiwancheng="'不达标率'"
                  v-if="showAll ||showComponents[36]" :data = "getbshineizhikong()"/>
                <bshineizhikongBar style="height:100%"  :width="displayType=='row' ? '75%': '100%'" :colorw = "colorw" :id="'snzkb'"
            ...
            <div class="congxiebox7" style="display:inline-block;width:98%;margin-right:1%;margin-left:1%;height:43%;" v-if="pageOT==4">
              ...
              <div class="componentsData" style="height:87%" v-if="relOf">
                <shijianzhipingPie style="height:100%"  :width="displayType=='row' ? '25%': '100%'" :colorw = "colorw" :id="'sjzp'" :wancheng="'合格率'" :weiwancheng="'不合格率'"
                  v-if="showAll ||showComponents[38]" :data = "getshijianzhiping()"/>
                <shijianzhipingBar style="height:100%"  :width="displayType=='row' ? '75%': '100%'" :colorw = "colorw" :id="'sjzpb'"
            ...
            <div class="congxiebox7" style="display:inline-block;width:98%;margin-right:1%;margin-left:1%;height:43%;" v-if="pageOT==5">
              ...
              <div class="componentsData" style="height:87%" v-if="relOf">
                <!-- <buhegeyangpinPie style="height:100%"  :width="displayType=='row' ? '25%': '100%'" :colorw = "colorw"
                  v-if="zaigangrenyuan.length>0&&(showAll || showComponents[24])" :data = "getbuhegeyangpin()"/> -->
                <shiyanshibiduiPie style="height:100%"  :width="displayType=='row' ? '25%': '100%'" :colorw = "colorw" :id="'sysjbd'" :wancheng="'对比合格率'" :weiwancheng="'对比不合格率'"
                  v-if="showAll ||showComponents[40]" :data = "getshiyanshibidui()"/>
                <shiyanshibiduiBar style="height:100%"  :width="displayType=='row' ? '75%': '100%'" :colorw = "colorw" :id="'sysjbdb'"
            ...
            <div class="congxiebox7" style="display:inline-block;width:98%;margin-right:1%;margin-left:1%;height:43%;" v-if="pageOT==5">
              ...
              <div class="componentsData" style="height:87%" v-if="relOf">
                <shebeibuliangPie style="height:100%"  :width="displayType=='row' ? '25%': '100%'" :colorw = "colorw" :id="'sbbl'" :wancheng="'符合率'" :weiwancheng="'不符合率'"
                  v-if="showAll ||showComponents[42]" :data = "getshebeibuliang()"/>
                <shebeibuliangBar style="height:100%"  :width="displayType=='row' ? '75%': '100%'" :colorw = "colorw" :id="'sbblb'"
            ...
            <div class="congxiebox7" style="display:inline-block;width:98%;margin-right:1%;margin-left:1%;height:43%;" v-if="pageOT==6">
              ...
              <div class="componentsData" style="height:87%" v-if="relOf">
                <!-- <buhegeyangpinPie style="height:100%"  :width="displayType=='row' ? '25%': '100%'" :colorw = "colorw"
                  v-if="zaigangrenyuan.length>0&&(showAll || showComponents[24])" :data = "getbuhegeyangpin()"/> -->
                <kehumanyiPie style="height:100%"  :width="displayType=='row' ? '25%': '100%'" :colorw = "colorw" :id="'khmy'" :wancheng="'满意率'" :weiwancheng="'不满意率'"
                  v-if="showAll ||showComponents[44]" :data = "getkehumanyi()"/>
                <kehumanyiBar style="height:100%"  :width="displayType=='row' ? '75%': '100%'" :colorw = "colorw" :id="'khmyb'"
            ...
            <div class="congxiebox7" style="display:inline-block;width:98%;margin-right:1%;margin-left:1%;height:43%;" v-if="pageOT==6">
              ...
              <div class="componentsData" style="height:87%" v-if="relOf">
                <ygcjpxcsdbPie style="height:100%"  :width="displayType=='row' ? '25%': '100%'" :colorw = "colorw" :id="'ygcjpxcsdb'" :wancheng="'达标率'" :weiwancheng="'不达标率'"
                  v-if="showAll ||showComponents[46]" :data = "getygcjpxcsdb()"/>
                <ygcjpxcsdbBar style="height:100%"  :width="displayType=='row' ? '75%': '100%'" :colorw = "colorw" :id="'ygcjpxcsdbb'"
            ...
            <div class="congxiebox7" style="display:inline-block;width:98%;margin-top:2%;margin-right:1%;margin-left:1%;height:90%;" v-if="pageOT==pageAll+7">
              ...
              <div class="componentsData" style="height:87%" v-if="relOf">
                <s4renYuanPeiXun style="height:50%"  :width="displayType=='row' ? '25%': '100%'" :colorw = "colorw"
                  v-if="zaigangrenyuan.length>0&&(showAll || showComponents[1])" :data = "getS4renYuanPeiXun()"/>
                <s4renYuanPeiXunCol style="height:50%"  :width="displayType=='row' ? '75%': '100%'" :colorw = "colorw" :direction="direction"
                  v-if="zaigangrenyuanfb.length>0&&(showAll || showComponents[2])" :data = "getS4renYuanPeiXunFB()"/>
                <div class="nullDate1" style="height:50%;width:75%;" v-if="zaigangrenyuanfb.length<=0&&(showAll || showComponents[2])">暂无数据</div>
                <s5renYuanJianDu style="height:50%"  :width="displayType=='row' ? '25%': '100%'" :colorw = "colorw"
                  v-if="showAll || showComponents[3]" :data = "getS5renYuanJianDu()"/>
                <s5renYuanJianDuCol style="height:50%"  :width="displayType=='row' ? '75%': '100%'" :colorw = "colorw" :direction="direction"
            ...
            <div class="congxiebox7" style="display:inline-block;width:98%;margin-top:2%;margin-right:1%;margin-left:1%;height:90%;" v-if="pageOT==pageAll+8">
              ...
              <div class="componentsData" style="height:87%" v-if="relOf">
                  <s7sheBeiJiaoZhun style="height:50%" :width="displayType=='row' ? '25%': '100%'" :colorw = "colorw"
                  v-if="showAll || showComponents[5]" :data = "getJiaoYanObjNum()"/>
                  <s7sheBeiJiaoZhunCol style="height:50%" :width="displayType=='row' ? '75%': '100%'" :colorw = "colorw" :direction="direction"
                  ...
                  <s8sheBeiHeCha style="height:50%"  :width="displayType=='row' ? '25%': '100%'" :colorw = "colorw"
                  v-if="showAll || showComponents[7]" :data = "gethechaObjNum()"/>
                  <s8sheBeiHeChaCol style="height:50%"  :width="displayType=='row' ? '75%': '100%'" :colorw = "colorw" :direction="direction"
            ...
            <div class="congxiebox7" style="display:inline-block;width:98%;margin-top:2%;margin-right:1%;margin-left:1%;height:90%;" v-if="pageOT==pageAll+9">
              ...
              <div class="componentsData" style="height:87%" v-if="relOf">
                  <s9neiBuZhiLiang style="height:50%" :width="displayType=='row' ? '25%': '100%'" :colorw = "colorw"
                  v-if="showAll || showComponents[9]" :data = "getS9neiBuZhiLiang()"/>
                  <s9neiBuZhiLiangCol style="height:50%" :width="displayType=='row' ? '75%': '100%'" :colorw = "colorw" :direction="direction"
                  ...
                  <s10waiBuNengLi style="height:50%" :width="displayType=='row' ? '25%': '100%'" :colorw = "colorw" 
                  v-if="showAll || showComponents[11]" :data = "getnengtliObjNum()"/>
                  <s10waiBuNengLiCol style="height:50%" :width="displayType=='row' ? '75%': '100%'" :colorw = "colorw" :direction="direction"
            ...
            <div class="congxiebox7" style="display:inline-block;width:98%;margin-top:2%;margin-right:1%;margin-left:1%;height:90%;" v-if="pageOT==pageAll+10">
              ...
              <div class="ttitle" style="text-align: center;">五、质量管理</div>
              <div class="componentsData" style="height:87%" v-if="relOf">
                  <s15tousu style="height:50%" :width="displayType=='row' ? '25%': '100%'" :colorw = "colorw"
                  v-if="showAll || showComponents[13]" :data = "getS3tousu()"/>
                  <s15tousuCol style="height:50%" :width="displayType=='row' ? '75%': '100%'" :colorw = "colorw" :direction="direction"
                  ...
                  <s12fengXian style="height:50%" :width="displayType=='row' ? '25%': '100%'" :colorw = "colorw"
                  v-if="showAll || showComponents[15]" :data = "getS12fengXian()"/>
                  <s12fengXianCol style="height:50%" :width="displayType=='row' ? '75%': '100%'" :colorw = "colorw" :direction="direction"
            ...
            <div class="congxiebox7" style="display:inline-block;width:98%;margin-right:1%;margin-left:1%;height:43%;" v-if="pageOT==pageAll+11">
              <div class="ttitle" style="text-align: center;">五、质量管理</div>
              <div class="componentsData" style="height:87%" v-if="relOf">
                <shijiazhipinjihuaPie style="height:100%"  :width="displayType=='row' ? '25%': '100%'" :colorw = "colorw" :id="'sjzpjh'"
                  v-if="showAll ||showComponents[46]" :data = "getshijiazhipinjihua()"/>
                <shijiazhipinjihuaBar style="height:100%"  :width="displayType=='row' ? '75%': '100%'" :colorw = "colorw" :id="'sjzpjhb'"
            ...
            <div class="congxiebox7" style="display:inline-block;width:98%;margin-top:2%;margin-right:1%;margin-left:1%;height:90%;" v-if="pageOT==pageAll+12">
              ...
              <div class="ttitle" style="text-align: center;">五、质量管理</div>
              <div class="componentsData" style="height:87%" v-if="relOf">
                  <s2manYiDu style="height:50%" :width="displayType=='row' ? '25%': '100%'" :colorw = "colorw" 
                  v-if="showAll || showComponents[17]"  :data = "getS2manYiDu()"/>
                  <s2manYiDuCol style="height:50%" :width="displayType=='row' ? '75%': '100%'" :colorw = "colorw" :direction="direction" 
                  ...
                  <s14bufuhexiang style="height:50%" :width="displayType=='row' ? '100%': '100%'" :colorw = "colorw" :direction="direction" 
            ...
            <div class="congxiebox7" style="display:inline-block;width:98%;margin-top:2%;margin-right:1%;margin-left:1%;height:90%;" v-if="pageOT==pageAll+13">
              ...
              <div class="ttitle" style="text-align: center;">五、质量管理</div>
              <div class="componentsData" style="height:87%" v-if="relOf">
                  <s1zhiLiangMuBiao style="height:50%" :width="displayType=='row' ? '25%': '100%'" :colorw = "colorw" 
                  v-if="showAll || showComponents[21]" :data = "getS1renwu()"/>
                  <s1zhiLiangMuBiaoCol style="height:50%" :width="displayType=='row' ? '75%': '100%'" :colorw = "colorw" :direction="direction"
                  ...
                  <s16bzJunZhu style="height:50%" :width="displayType=='row' ? '100%': '100%'" :colorw = "colorw" :direction="direction"
            ...
            <!-- <div class="congxiebox7" style="display:inline-block;width:98%;margin-top:2%;margin-right:1%;margin-left:1%;height:90%;" v-if="pageOT==7">
              ...
              <div class="componentsData" style="height:95%" v-if="relOf"> -->
                  <!-- <s11biaoZhunWu style="height:100%" :width="displayType=='row' ? '100%': '100%'" :colorw = "colorw"
            ...
            <div style="height:90%;margin-top:1%"  v-if="pageOT>6&&pageOT<pageAll+7">
              <div  style="display:inline-block; height:100%;width:100%;" >
                ...
                <div class="componentsData" style="height:100%" v-if="relOf">
                    ...
                    <s13shengWu :height="'290%'" :width="displayType=='row' ? '19.5%': '100%'" :colorw = "colorw" :mubiao = "quality[4].val"
      ...
      methods: {
        ...
        getConfigData (end, allDept, filterDept) {
          ...
          Promise.all([
            ...
            repostCurd('query', getzaigangrenyuanObj(end, filterDept)),
            repostCurd('query', getgangqianpeixunObj(end, filterDept)),
            repostCurd('query', getJiaoYanObj(end, filterDept)),
            repostCurd('query', getJiaoYanObjFB(end, filterDept)),
            repostCurd('query', gethechaObj(end, filterDept)),
            repostCurd('query', gethechaObjFB(end, filterDept)),
            repostCurd('query', getwaibuObj(end, filterDept)),
            repostCurd('query', getneibuObj(end, filterDept)),
            repostCurd('query', getyingjiObj(end, filterDept)),
            repostCurd('query', getfengxianObj(end, filterDept)),
            repostCurd('query', getneishenObj(end, filterDept)),
            repostCurd('query', getguanshenObj(end, filterDept)),
            repostCurd('query', getbufuheObj(end, filterDept)),
            repostCurd('query', getgaijinxiangObj(end, filterDept)),
            repostCurd('query', getzaigangrenyuanFBObj(end, filterDept)),
            repostCurd('query', getgangqianpeixunFBObj(end, filterDept)),
            repostCurd('query', getneibuObjFB(end, filterDept)),
            repostCurd('query', getwaibuObjFB(end, filterDept)),
            repostCurd('query', getyingjiObjFB(end, filterDept)),
