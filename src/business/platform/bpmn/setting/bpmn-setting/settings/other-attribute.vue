        ...
        >
            <el-form-item :style="{ marginBottom: '10px' }">
                ...
                <bpmn-form-var
                    :data="formVars"
                    :props="{ label: 'name' }"
                    @callback="handleFormVar"
                />
            </el-form-item>
            <div class="ibps-pb-5">
                <codemirror
                    ref="subjectRule"
                    v-model="attribute.subjectRule"
                    :options="cmOption"
                />
            </div>
            ...
            <el-form-item
                v-if="!attribute.hideSkipFirstNode"
                label="跳过第一个节点:"
            >
            ...
            <el-form-item label="第一个节点可以选择执行人:">
                <el-radio-group
                    v-model="attribute.firstNodeUserAssign"
                    class="ibps-mt-20"
                >
                    <el-radio :label="true">是</el-radio>
                    <el-radio :label="false">否</el-radio>
            ...
            <el-form-item>
                <template
                    slot="label"
                >相邻节点相同<br>执行人直接跳过:</template>
                <el-radio-group
                    v-model="attribute.skipSameUser"
                    class="ibps-mt-20"
                >
                    <el-radio :label="true">是</el-radio>
                    <el-radio :label="false">否</el-radio>
            ...
            <el-form-item>
                ...
                <el-radio-group
                    v-model="attribute.skipExecutorEmpty"
                    class="ibps-mt-20"
                >
                    <el-radio :label="true">是</el-radio>
                    <el-radio :label="false">否</el-radio>
