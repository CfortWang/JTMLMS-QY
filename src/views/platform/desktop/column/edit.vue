            ...
            <el-row>
                ...
                <el-col :span="12">
                    <el-form-item label="公共栏目:" prop="isPublic">
                        <el-switch
                            v-if="!readonly"
                            v-model="desktopColumn.isPublic"
                            :active-value="true"
            ...
            <el-row>
                <el-col :span="12" style="height:51px;">
                    <el-form-item label="支持刷新:" prop="supportRefesh">
                        <el-switch
                            v-if="!readonly"
                            v-model="desktopColumn.supportRefesh"
                            :active-value="true"
                            :inactive-value="false"
                            active-text="是"
                            inactive-text="否"
                        ...
                        <template v-if="desktopColumn.supportRefesh">
                            <el-input v-if="!readonly" v-model="desktopColumn.refeshTime" placeholder="刷新时间" style="width:100px;" />
                ...
                <el-col :span="24">
                    <el-form-item label="描述:" prop="memo">
                        ...
                        <pre v-else class="ibps-m-0">{{ desktopColumn.memo }}</pre>
                    </el-form-item>
                </el-col>
                <el-col :span="24">
