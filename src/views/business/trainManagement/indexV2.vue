            ...
            <dv-border-box-1>
                <div class="vessel">
                    <dv-border-box-12 class="areaTop" :color="dvColor" :background-color="dvBackColor">
                        <div class="area">
                            <job-plan-chart :id="1" v-model="nowWeekData" class="merge" :title="mergeData[1].title" :data="mergeData[1].numData" :width="'63%'" :height="'75%'" />
                            <dv-decoration-2 :key="`line1`" :color="dvLineColor" :reverse="true" :dur="6" style="width:1%;height:85%;margin: auto;" />
                            <pie-chart :id="1" v-model="mergeData[0].numData" class="tabular" :title="mergeData[0].title" :total="mergeData[0].total" :width="'32%'" :height="'75%'" />
                        </div>
                    </dv-border-box-12>
                    <div style="width:100%;height:2.64%" />
                    <dv-border-box-12 class="areaBottom" :color="dvColor" :background-color="dvBackColor">
                        <div class="area">
                            <training-staff-chart :id="1" v-model="mergeData[2].numData" class="merge" :title="mergeData[2].title" :data="mergeData[2].perList" :width="'63%'" :height="'75%'" />
                            <dv-decoration-2 :key="`line2`" :color="dvLineColor" :reverse="true" :dur="6" style="width:1%;height:85%;margin: auto;" />
                            <pie-chart :id="2" v-model="mergeData[3].numData" class="tabular" :title="mergeData[3].title" :total="mergeData[3].total" :width="'32%'" :height="'75%'" />
                        </div>
                    </dv-border-box-12>
                </div>
            </dv-border-box-1>
