    ...
    >
        ...
        >
            ...
            <el-form-item label="描述:" prop="roleNote">
                ...
                <pre v-else class="ibps-m-0">{{ role.roleNote }}</pre>
            </el-form-item>

            <!-- <el-form-item label="统计页面权限:" prop="roleType">
                <el-radio v-model="role.roleType" label="主任">主任(全中心)</el-radio>
                <el-radio v-model="role.roleType" label="负责人">负责人</el-radio>
                <el-radio v-model="role.roleType" label="普通员工">普通员工</el-radio>
            </el-form-item> -->
        </el-form>
