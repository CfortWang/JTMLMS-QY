...
export default {
    ...
    methods: {
        ...
        getQuestionData () {
            ...
            const key = this.examId ? 'getExaminationDetailByEid' : 'getExaminationDetail'
            const p = this.examId ? [this.bankId, this.examId, this.examineeId] : [this.bankId, this.examineeId]
