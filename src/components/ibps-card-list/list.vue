<template>
    <ibps-container v-loading="loading" type="full" class="ibps-card-list-container">
        ...
        <div slot="header" class="ibps-card-list__header">
            <h5 v-if="title" class="ibps-card-list__title tzTitle">{{ title }}</h5>
            <div
...
<style  scoped>
    .ibps-card-list__item{
        text-align: center;
    }
    .ibps-card-list-container >>> .ibps-container-full__header{
        padding: 0px!important;
    }
    .ibps-card-list__item >>> .ibps-card-list__item-symbol{
        top: 35px!important;left:53px!important;
    }
    ::v-deep .ibps-toolbar .toolbar-box{
        border: 0px;
        padding-top: 0px;
    }
...
<style>
    .person-office-head .header {
        padding: 5px 0px;height: 35px;
    }
    .person-office-head .tools {
        display: inline-block;
    }
    .person-office-head .el-button--small {
        color: #fff;font-size: 12px;padding: 9px 15px;border-radius: 3px;background-color: #409eff;border-color: #409eff;
    }
    .person-office-head .el-button--small span{
        height: 32px;line-height: 16px;min-width: 0;
    }
    .ibps-card-list__item-detail-name,
    .ibps-card-list__item-detail-partyTypeName,
    .ibps-card-list__item-detail-createTime,
    .ibps-card-list__item-detail-taskName,
    .ibps-card-list__item-detail-completeTime,
